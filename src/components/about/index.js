...
export default function About() {
  return (
    <>
      <Container style={{ justifyContent: 'center', marginTop: '5rem', marginBottom: '5rem', width: '85%' }}>
